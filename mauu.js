var teksSekarang = 1; var ftom = 0; var pesanwhatsapp = "Aku pilih nomor: "; const body = document.querySelector("body"); audio = new Audio('' + linkmp3.src);
    ...
    async function jawab() { await swals.fire('Kirim jawabannya<br>ke WhatsApp aku, ya! 😆'); window.location = "https://api.whatsapp.com/send?phone=6282139813149&text=" + Mauu dongg sayangg; }
